				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="addPatient.jsp">Add Patient</a> <a
							class="dropdown-item" href="mainMenuAdmin.jsp">Patient
							List</a>
							<a class="dropdown-item" href="generatedBills.jsp">Billing</a>
					</div></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
			...
			<div id="pagination-container">
				...
				<table border="1" class="table" id="patient-table">
					...
					<tr class="patient-row">
						...
						<td><a class="btn" href=./vieweditpatient.jsp?id=<%=rs.getInt(1)%>> View/Edit </a></td>
					</tr>
