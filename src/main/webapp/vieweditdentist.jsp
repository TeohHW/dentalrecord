...
<body onload="hideFunction()">
	...
	try {
		...
		String userQuery = "select iduserAccounts from users where useremail in (select email from dentist where iddentist = " + id+ ")";
		...
		sql = "select * from dentist where iddentist = " + id + " and clinicId = " + clinicId;
			...
			<div class="container-contact100">
				<div class="wrap-contact100">
					<div class="contact100-form-title"
						...
						<span class="contact100-form-title-1"> Dentist Details </span>
					</div>

					<form class="contact100-form validate-form" action="updateDentist"
						...
						<div class="wrap-input100 validate-input"
							...
							<span class="label-input100"><i
								...
								type="text" name="icnum" id="icnum" value=<%=rs.getString(3)%>>
					...
					<form method="post" action="deleteDentist"
