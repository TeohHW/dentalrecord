...
<title>Assistant Home Page</title>
<link rel="stylesheet"
			...
			<ul class="navbar-nav ml-auto" style="margin-right: 70px;">
				...
				<li class="nav-item dropdown"><a
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="addInventory.jsp">Add Item
                            </a> <a class="dropdown-item" href="inventorylist.jsp">Inventory List</a>
                    </div></li>
			</ul>
		</div>
	</nav>
	...
	<section class="page-section portfolio" id="dashboard">
		<div class="container">
			...
			<div class="container-contact100-form-btn">
				<a class="contact100-form-btn btn-update" href="createBill.jsp">Bill Services</a> 
			</div>
		</div>
	</section>
				...
				<p>Upcoming Appointments:</p>
					...
					<table border="1" class="table" id="patient-table">
						...
						<tr class="patient-row">
							...
							<td><a class="btn" href="viewpatientinfo.jsp?id=<%=rss.getInt(1)%>&appid=<%=rss.getInt(2)%>">View</a></td>
