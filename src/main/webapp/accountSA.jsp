...
<body onload="hideFunction()">
			...
			<div class="container-contact100">
				<div class="wrap-contact100">
					...
					<form class="contact100-form validate-form"
						action="UpdateAccountDetailsSA" method="post" class="register-form"
	...
	<script>
		...
		function updateParticulars() {
			var x = document.getElementById("hiddenTextbox");
			var y = document.getElementById("hiddenUpdateBtn");
			var z = document.getElementById("hiddenMessage");
