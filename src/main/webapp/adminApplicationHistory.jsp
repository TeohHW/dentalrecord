		...
		<div class="container">
			<div id="pagination-container">
				...
				try {
					...
					if (query != null) {
						data = "select * from adminapphistory where name like '%" + query + "%' or clinicName like '%" + query
						+ "%' or email like '%" + query + "%'";
					} else
						data = "select * from adminapphistory ORDER by idadminAppHistory asc";
				...
				<table border="1" class="table" id="patient-table">
					<tr>
						...
						<th style="width:20%;">Clinic Address</th>
						<th style="width:20%;">Clinic Contact No.</th>
