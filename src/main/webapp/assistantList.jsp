...
<title>Clinic Assistant List</title>
<link rel="stylesheet"
		...
		<div class="container">
			<div id="pagination-container">
				...
				try {
					...
					String data;
				if (query != null) {
						data = "select * from assistant where name like '%" + query + "%' AND clinicId like '%" + (int)session.getAttribute("clinicId") + 
					...
					data = "select * from assistant where clinicId like '%" + (int)session.getAttribute("clinicId") + "%' ORDER BY idassistant asc";
				...
				<table border="1" class="table" id="patient-table">
					...
					<tr class="patient-row">
						...
						<td><a class="btn"
								href=./vieweditassistant.jsp?id=<%=rs.getInt(1)%>> View/Edit </a></td>
					</tr>
